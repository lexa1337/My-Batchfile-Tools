@echo off
mode 110,40
title Windows DOS Attack Tools
cls
echo.
...
goto login
:NEXTY
echo [40;32mOk [40;33m%name%, [40;32mWelcome to tools DOS Attack
echo.
...
echo [40;34m       :+oyNNNNNNNNNNNNNdmNy-                   [*][40;37mAuthor : ~ Lexa 
echo [40;34m      `+mNNNmy++//+shmNNNNNNNh:                 [*][40;37mType : DOS Attack     
echo [40;34m     -yNNNd:         `:ymNNNNmmh.               [*][40;37mTeam : Lexa's Hell
